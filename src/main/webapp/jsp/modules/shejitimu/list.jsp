...
<!--/Pre Loader -->
    ...
    <script>
        ...
        function setDataRow(item, number) {
            ...
            //赞成票
            var shejitimuZanchengCell = document.createElement('td');
            shejitimuZanchengCell.innerHTML = item.shejitimuZancheng;
            row.appendChild(shejitimuZanchengCell);


            //反对票
            var shejitimuFanduiCell = document.createElement('td');
            shejitimuFanduiCell.innerHTML = item.shejitimuFandui;
            row.appendChild(shejitimuFanduiCell);
